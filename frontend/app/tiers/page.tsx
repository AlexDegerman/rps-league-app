        ...
        <div className="flex flex-col gap-2 pb-20">
          ...
          <div className="bg-white rounded-xl border border-[#e8e6e1]/60 p-4 shadow-sm">
            <div className="flex justify-between items-start mb-3">
              ...
              >
                <span className="g-str">1.2Str</span>
              </div>
            </div>
            <div className="text-[11px] text-[#aaa] font-[DM_Mono] leading-normal border-t border-[#f8f7f4] pt-3">
              Smoked amethyst gradient text framed by a fine gold stroke and
              active drop shadows. An elegant 3-peak royal crown with a shifting
              horizontal gold-purple shimmer hovers statically above the
              numbers, while a high-fidelity concentric shockwave expands
              outwards in a multi-stage radial sequence.
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl border border-[#e8e6e1]/60 p-4 shadow-sm">
            <div className="flex justify-between items-start mb-3">
              <div className="font-[DM_Mono]">
                ...
                <div className="flex items-center gap-2">
                  <span className="text-[10px] text-[#aaa]">10¹⁰⁸</span>
                  <span className="text-[9px] py-0.5 px-1.5 rounded bg-[#fffbeb] text-[#b45309] font-medium uppercase tracking-wider">
                    dune illusion
                  </span>
                </div>
              </div>
              <div className="text-2xl font-bold leading-none tracking-tight">
                <span className="g-qntr" data-text="1.2Qntr">
                  1.2Qntr
                </span>
              </div>
            </div>
            <div className="text-[11px] text-[#aaa] font-[DM_Mono] leading-normal border-t border-[#f8f7f4] pt-3">
              Neon-gold gradient text flowing with shifting, diagonal windswept
              ripples. An unstable, left-trailing mirage shadow skews to trick
              depth perception, while a dense, localized sandstorm blast sweeps
              strictly from right to left above and below the characters inside
              a tight, card-safe aura.
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl border border-[#e8e6e1]/60 p-4 shadow-sm">
            <div className="flex justify-between items-start mb-3">
              ...
              <div
                ...
                style={{ overflow: 'visible' }}
              >
                <span className="g-qtr">1.2Qtr</span>
              </div>
            </div>
            <div className="text-[11px] text-[#aaa] font-[DM_Mono] leading-normal border-t border-[#f8f7f4] pt-3">
              Shifting star-white and lavender-purple gradient text pulsing with
              a steady cosmic flow. A smooth, 4-pointed lens flare starburst
              collapses and explodes radially in a continuous rotation loop,
              accompanied by a backdrop contrast bloom and thirty-two glowing,
              multi-colored plasma sparks.
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl border border-[#e8e6e1]/60 p-4 shadow-sm">
            <div className="flex justify-between items-start mb-3">
              <div className="font-[DM_Mono]">
                ...
                <div className="flex items-center gap-2">
                  <span className="text-[10px] text-[#aaa]">10¹⁰²</span>
                  <span className="text-[9px] py-0.5 px-1.5 rounded bg-[#fff7ed] text-[#c2410c] font-medium uppercase tracking-wider">
                    solar prominence
                  </span>
                </div>
              </div>
              <div className="text-2xl font-bold leading-none tracking-tight">
                <span className="g-ttr">1.2Ttr</span>
              </div>
            </div>
            <div className="text-[11px] text-[#aaa] font-[DM_Mono] leading-normal border-t border-[#f8f7f4] pt-3">
              Deep plasma-gold gradient text shifting with slow, golden-orange
              plasma flows and pulsating drop shadows. A volumetric light-cone
              funnel casts down from above directly into a majestic 5-peak Solar
              Crown that sways and flares to extreme brightness, radiating an
              intense gold-and-amber solar outshine.
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl border border-[#e8e6e1]/60 p-4 shadow-sm">
            <div className="flex justify-between items-start mb-3">
              <div className="font-[DM_Mono]">
                ...
                <div className="flex items-center gap-2">
                  <span className="text-[10px] text-[#aaa]">10⁹⁹</span>
                  <span className="text-[9px] py-0.5 px-1.5 rounded bg-[#ecfdf5] text-[#047857] font-medium uppercase tracking-wider">
                    razor tempest
                  </span>
                </div>
              </div>
              <div
                ...
                style={{ overflow: 'visible' }}
              >
                <span className="g-dtr" data-text="1.2Dtr">
                  1.2Dtr
                </span>
              </div>
            </div>
            <div className="text-[11px] text-[#aaa] font-[DM_Mono] leading-normal border-t border-[#f8f7f4] pt-3">
              Slate-and-emerald gradient text flowing with active green
              highlights, backed by a sharp, flat emerald text-duplicator
              shadow. A razor-sharp, tilted parallelogram wind-shear wall with
              solid guidelines and sharp, diagonal green storm lines sweeps
              rapidly from right to left alongside chaotic wind and lightning
              symbols.
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl border border-[#e8e6e1]/60 p-4 shadow-sm">
            <div className="flex justify-between items-start mb-3">
              ...
              <div className="text-2xl font-bold leading-none tracking-tight">
                <span className="g-utr" data-text="1.2Utr">
                  1.2Utr
                </span>
              </div>
            </div>
            <div className="text-[11px] text-[#aaa] font-[DM_Mono] leading-normal border-t border-[#f8f7f4] pt-3">
              Platinum-silver gradient text anchored by smoked-slate outer edges
              and a sharp slate-gray stroke. Framed by a wind-buffeted dark
              silhouette shadow, a smooth white-silver wind-shear wall and
              flying draft-wind symbols sweep horizontally from right to left
              with high contrast.
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl border border-[#e8e6e1]/60 p-4 shadow-sm">
            <div className="flex justify-between items-start mb-3">
              <div className="font-[DM_Mono]">
                ...
                <div className="flex items-center gap-2">
                  <span className="text-[10px] text-[#aaa]">10⁹³</span>
                  <span className="text-[#0f766e] text-[9px] py-0.5 px-1.5 rounded bg-[#f0fdfa] font-medium uppercase tracking-wider">
                    leviathan maelstrom
                  </span>
                </div>
              </div>
              <div className="text-2xl font-bold leading-none tracking-tight">
                <span className="g-trg">1.2Trg</span>
              </div>
            </div>
            <div className="text-[11px] text-[#aaa] font-[DM_Mono] leading-normal border-t border-[#f8f7f4] pt-3">
              Teal-and-emerald gradient text flowing with active cyan
              undercurrents. A wide, majestic water twister sways and spins
              dynamically directly above the numbers, while a violently jagged,
              rocky tsunami wavefront below surges and crashes vertically with a
              white foaming crest sliding across its peaks.
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl border border-[#e8e6e1]/60 p-4 shadow-sm">
            <div className="flex justify-between items-start mb-3">
              <div className="font-[DM_Mono]">
                ...
                <div className="flex items-center gap-2">
                  <span className="text-[10px] text-[#aaa]">10⁹⁰</span>
                  <span className="text-[9px] py-0.5 px-1.5 rounded bg-[#eff6ff] text-[#1d4ed8] font-medium uppercase tracking-wider">
                    abyssal trench
                  </span>
                </div>
              </div>
              <div className="text-2xl font-bold leading-none tracking-tight">
                <span className="g-nvg">1.2Nvg</span>
              </div>
            </div>
            <div className="text-[11px] text-[#aaa] font-[DM_Mono] leading-normal border-t border-[#f8f7f4] pt-3">
              Deep midnight-blue base highlighted by a thin neon-cyan stroke and
              sapphire drop shadows. An active, slow-pulsing sapphire-and-cobalt
              deep-sea aura glows from behind, while three staggered columns of
              sapphire-blue spores sink and drift downwards from the bottom edge
              of the characters.
            </div>
          </div>
          {/* SECTION: SEASON 1 */}
