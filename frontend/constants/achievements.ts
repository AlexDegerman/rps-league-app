...
export const CATEGORY_LABELS: Record<string, string> = {
  ...
  ArkalonProphecy: 'Arkalon Prophecy',
  Meta: 'Meta & Special',
...
export const ACHIEVEMENT_BADGE_MAP: Record<string, BadgeData> = {
  ...
  // Arkalon Prophecy
  ARK3: { code: 'ARK3', name: 'Seer Apprentice', icon: '🔮', rarity: 'COMMON' },
  ARK7: { code: 'ARK7', name: 'Clairvoyant', icon: '🌠', rarity: 'RARE' },
  ARKL: { code: 'ARKL', name: 'Prophet', icon: '👁️', rarity: 'EPIC' },
  CHRON: {
    code: 'CHRON',
    name: 'Chrono Scholar',
    icon: '📅',
...
export const CATEGORY_CHAINS: Record<string, string[]> = {
  ...
  ArkalonProphecy: ['ARK3', 'ARK7', 'ARKL', 'CHRON', 'OMNI'],
  Festival: [
    'FES1',
    'FES2',
    'FES3',
...
export const STANDALONE_CATEGORIES = new Set(['Meta', 'Miscellaneous', 'Rainbow'])
...
export const BADGE_REQUIREMENT: Record<string, string> = {
  ...
  ARK3: 'Use Arkalon 3 Days in a Row',
  ARK7: 'Use Arkalon 7 Days in a Row',
  ARKL: 'Use Arkalon 14 Days in a Row',
  CHRON: 'Use Arkalon 30 Days in a Row',
  OMNI: 'Use Arkalon 60 Days in a Row',
  ...
  OVIS: 'Complete all 5 sequences in Arkalon Vision',
