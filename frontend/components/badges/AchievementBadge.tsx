...
export function AchievementBadge({
  ...
  const requirement = BADGE_REQUIREMENT[badge.code]

  return (
    <span
      className={`
        inline-flex items-center rounded-md border font-black uppercase tracking-wider achievement-badge-tooltip
        ${sizeClass}
        ${
          isRainbow
