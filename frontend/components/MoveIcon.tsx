...
const PaperIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 120 120">
    <rect x="30" y="20" width="60" height="80" rx="6" fill="#F9FAFB" stroke="#374151" strokeWidth="4"/>
...
const ScissorsIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 120 120">
    <circle cx="40" cy="80" r="12" fill="none" stroke="#EF4444" strokeWidth="6"/>
    <circle cx="80" cy="80" r="12" fill="none" stroke="#EF4444" strokeWidth="6"/>
    <line x1="48" y1="72" x2="78" y2="38" stroke="#EF4444" strokeWidth="6" strokeLinecap="round"/>
    <line x1="72" y1="72" x2="42" y2="38" stroke="#EF4444" strokeWidth="6" strokeLinecap="round"/>
  </svg>
)
