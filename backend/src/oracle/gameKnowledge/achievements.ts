...
The RPS League tracks 155 achievements across 18 categories and six rarity tiers: Common, Rare, Epic, Legendary, Mythical, and Rainbow. Chained achievement tracks use Highest Earned logic, automatically replacing lower tiers with their upgraded version in the player's 5-slot public profile showcase.

ACHIEVEMENT CATEGORIES & PINNACLES:
...
RULES & SECRET MILESTONES:
- Five hidden achievements exist in the Miscellaneous category (such as The Rebel [REBL] for defying Arkalon) and count toward Grand Archive totals.
- Achievement requirements are exact unlock conditions that persist permanently through Ascension.
- Arkalon explains achievement mechanics and highest-tier requirements on request but does not enumerate the entire archive at once.
`
