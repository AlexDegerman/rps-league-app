...
- Moon's Blessing:
  * Unvigintillion (10^66): Moonlit. Navy-to-white gradient sweep, soft cyan bloom glow.
  * Duovigintillion (10^69): Full Eclipse. radial white-core over linear diagonal gradients.
- Electric Surge:
  * Trevigintillion (10^72): Charged. Purple neon solid with scripted flickering sequences.
  * Quattuorvigintillion (10^75): Supercell. Conic-gradient overlay, fractal lightning spokes, white-out filter.
- Luck in the Card:
  * Quinvigintillion (10^78): Holographic Foil. 7-stop oil-slick rainbow, rotating hue shadows.
  * Sexvigintillion (10^81): The Jackpot. Gold-pink-teal gradient, two orbiting 3D dice satellites.
- Hellfire:
  * Septenvigintillion (10^84): Molten. Orange-red cycling, heat-haze skew distortion, blur pulse.
  * Octovigintillion (10^87): Lava Overload. Gold to crimson radial gradient, magma-flow effect, sawtooth clip-path flame crown.
`
